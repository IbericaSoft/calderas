...
//			$this->oConnection->closeConnection();			
		...
		private function processTemplate(){
			...
			if ( $this->oOrderActionClass->getChannel()=='html' ){
				...
				/** disponibilidad de datos fijos en las paginas */
				$this->includekernelsData();
				...
				$htmlFirst 		= "<a href='javascript:pagination(".$this->oConnection->primeraPagina().")' title='Primera p&aacute;gina' ><IMG id='btFirst' SRC='$static/flechapagini.gif'/></a>&nbsp;";
				$htmlPrevious 	= "<a href='javascript:pagination(".($this->oConnection->paginaActual()-1).")' title='Primera p&aacute;gina' ><IMG id='btPrev'  SRC='$static/flechapagant.gif'></a>&nbsp;";
				$htmlNext 		= "<a href='javascript:pagination(".($this->oConnection->paginaActual()+1).")' title='P&aacute;gina siguiente' ><IMG id='btNext' SRC='$static/flechapagsig.gif'/></a>&nbsp;";
				$htmlLast 		= "<a href='javascript:pagination(".$this->oConnection->ultimaPagina().")' title='&Uacute;ltima p&aacute;gina' ><IMG id='btLast' SRC='$static/flechapagfin.gif'/></a>&nbsp;";
				$this->oConnection->setHtmlPagination($htmlFirst, $htmlPrevious, $htmlNext, $htmlLast);
				
				$this->oLogger->debug("channel html ".$this->oDataTemplate->getTemplate());
			...
			} else if ( $this->oOrderActionClass->getChannel()=='comet' ) {
				$this->oLogger->debug("datos comet:".$this->oDataTemplate->getKeyData('json'));
				//header('Content-Type: application/json');
				print $this->oDataTemplate->getKeyData('json');
